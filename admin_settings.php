            ...
            <tr>
              ...
              <td>
                <select name="langbf_active">
                  <option value="no" <?php if(get_option('langbf_active') == 'no'){ echo 'selected="selected"'; } ?> ><?php _e( 'No', LANGBF_TD ); ?></option>
                  <option value="yes" <?php if(get_option('langbf_active') == 'yes'){ echo 'selected="selected"'; } ?> ><?php _e( 'Yes', LANGBF_TD ); ?></option>
                </select>
            ...
            <tr>
              ...
              <td>
                <select name="langbf_disable_wpbar">
                  <option value="no" <?php if(get_option('langbf_disable_wpbar') == 'no'){ echo 'selected="selected"'; } ?> ><?php _e( 'No', LANGBF_TD ); ?></option>
                  <option value="yes" <?php if(get_option('langbf_disable_wpbar') == 'yes'){ echo 'selected="selected"'; } ?> ><?php _e( 'Yes', LANGBF_TD ); ?></option>
                </select>
            ...
            <tr>
              ...
              <td>
                <select name="langbf_new_window">
                  <option value="no" <?php if(get_option('langbf_new_window') == 'no'){ echo 'selected="selected"'; } ?> ><?php _e( 'No', LANGBF_TD ); ?></option>
                  <option value="yes" <?php if(get_option('langbf_new_window') == 'yes'){ echo 'selected="selected"'; } ?> ><?php _e( 'Yes', LANGBF_TD ); ?></option>
                </select>
